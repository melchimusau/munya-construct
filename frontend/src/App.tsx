...
// Restaure le token JWT AVANT le premier rendu, pour que tous les fetch du
// premier useEffect partent avec le bon header Authorization.
...
// ============================================================================
// Config déclarative des onglets
// ============================================================================
...
// ============================================================================
// InternalApp — tous les hooks sont appelés inconditionnellement
// ============================================================================
...
function InternalApp() {
  ...
  const handleUpdateEmployee = async (id: number, emp: Partial<EmployeeFE>) => {
    try {
...
function AppContent() {
  ...
  if (user?.must_change_password)
    return (
      <ResetPasswordView onPasswordChanged={() => window.location.reload()} />
    );
